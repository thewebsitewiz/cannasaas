...
export function CompliancePage() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold text-txt">Compliance & Metrc</h1>
      ...
      <div className="bg-surface rounded-xl border border-border p-6">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h2 className="text-lg font-semibold text-txt">Product Compliance</h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-xs text-txt-secondary">{compliance?.missingUid ?? 0} missing</p>
            </div>
          </div>
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-xs text-txt-secondary">{compliance?.missingCategory ?? 0} missing</p>
            </div>
          </div>
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-xs text-txt-secondary">{compliance?.missingPackageLabel ?? 0} missing</p>
            </div>
          </div>
          <div className="flex items-center gap-2">
            <CheckCircle size={16} className="text-green-500" />
            <div>
              ...
              <p className="text-xs text-txt-secondary">{compliance?.compliantProducts ?? 0} approved</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-surface rounded-xl border border-border p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
          ...
          <div>
            <p className="text-sm text-txt-secondary">Success</p>
