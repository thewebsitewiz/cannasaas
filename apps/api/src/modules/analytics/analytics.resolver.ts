...
export class AnalyticsResolver {
  ...
  async salesOverview(
    ...
    return this.analytics.getSalesOverview(
      this.resolveDispensary(user, dispensaryId),
      days ?? 30,
    );
  }
  ...
  async salesTrend(
    ...
    return this.analytics.getSalesTrend(
      this.resolveDispensary(user, dispensaryId),
      days ?? 30,
    );
  }
  ...
  async inventoryOverview(
    ...
    return this.analytics.getInventoryOverview(
      this.resolveDispensary(user, dispensaryId),
    );
  }
  ...
  async lowStockItems(
    ...
    return this.analytics.getLowStockItems(
      this.resolveDispensary(user, dispensaryId),
    );
  }
  ...
  async metrcSyncOverview(
    ...
    return this.analytics.getMetrcSyncOverview(
      this.resolveDispensary(user, dispensaryId),
    );
  }
  ...
  async complianceSummary(
    ...
    return this.analytics.getComplianceSummary(
      this.resolveDispensary(user, dispensaryId),
    );
  }
}
