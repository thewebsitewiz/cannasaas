...
export class ProductVariant {
  @Field(() => ID, { name: 'variantId' }) @PrimaryGeneratedColumn('uuid') variant_id!: string;

  @Field(() => ID, { name: 'productId' }) @Index() @Column({ type: 'uuid' }) product_id!: string;
  ...
  @Field(() => Float, { name: 'quantityPerUnit', nullable: true }) @Column({ type: 'decimal', precision: 10, scale: 4, nullable: true }) quantity_per_unit?: number;
  ...
  @Field({ name: 'metrcPackageLabel', nullable: true }) @Index() @Column({ nullable: true, length: 100 }) metrc_package_label?: string;
  @Field({ name: 'isActive' }) @Column({ default: true }) is_active!: boolean;
  @Field(() => Int, { name: 'sortOrder', nullable: true }) @Column({ nullable: true }) sort_order?: number;
