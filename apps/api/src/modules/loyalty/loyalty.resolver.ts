...
class LoyaltyTierInfo {
  @Field() name!: string;
  @Field() code!: string;
  @Field(() => Int) minPoints!: number;
  @Field(() => Float) multiplier!: number;
  @Field({ nullable: true }) perks?: string;
  @Field({ nullable: true }) color?: string;
}
@ObjectType()
class NextTierInfo {
  @Field() name!: string;
  @Field(() => Int) pointsNeeded!: number;
}
...
class MyLoyalty {
  ...
  @Field({ nullable: true }) tierColor?: string;
  @Field({ nullable: true }) tierPerks?: string;
  @Field(() => Float) multiplier!: number;
...
@ObjectType()
class LoyaltyReward {
  @Field(() => ID) rewardId!: string;
  @Field() name!: string;
  @Field({ nullable: true }) description?: string;
  @Field(() => Int) pointsCost!: number;
  @Field() rewardType!: string;
  @Field(() => Float) rewardValue!: number;
}

@ObjectType()
class RedeemResult {
  @Field(() => Int) newBalance!: number;
...
class BirthdayCheck {
  ...
  @Field(() => Int, { nullable: true }) bonusPoints?: number;
  @Field(() => Float, { nullable: true }) discountPercent?: number;
}
...
class LoyaltyStats {
  ...
  @Field(() => Int) totalRedeemed!: number;
  @Field(() => Int) redemptionCount!: number;
  @Field(() => Int) birthdayClaims!: number;
  @Field(() => [TierCount]) tierBreakdown!: TierCount[];
}
...
export class LoyaltyResolver {
  ...
  async pointHistory(
    ...
    return this.loyalty.getPointHistory(user.sub, limit) as unknown as Promise<
      PointTransaction[]
    >;
  }
  ...
  async rewards(
    ...
    return this.loyalty.getRewards(dispensaryId) as unknown as Promise<
      LoyaltyReward[]
    >;
  }
  ...
  async redeem(
    ...
    const result = await this.loyalty.redeemPoints(
      user.sub,
      dispensaryId,
      rewardId,
      orderId,
  ...
  async claimBirthday(
    ...
    return this.loyalty.claimBirthdayBonus(
      user.sub,
      dispensaryId,
    ) as unknown as Promise<PointTransaction | null>;
  }
  ...
  async createReward(
    ...
    return this.loyalty.createReward(dispensaryId, {
      name,
      description,
      pointsCost,
      rewardType,
