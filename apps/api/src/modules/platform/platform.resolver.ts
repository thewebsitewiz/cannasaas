...
class TenantStats {
  ...
  @Field(() => Int) trial!: number;
  @Field(() => Int) suspended!: number;
}
@ObjectType()
class RevenueStats {
  @Field(() => Float) mrr!: number;
  @Field(() => Float) arr!: number;
}
@ObjectType()
class DispStats {
  @Field(() => Int) total!: number;
  @Field(() => Int) active!: number;
  @Field(() => Int) states!: number;
}
@ObjectType()
class UserStats {
  @Field(() => Int) total!: number;
  @Field(() => Int) customers!: number;
  @Field(() => Int) staff!: number;
  @Field(() => Int) active24h!: number;
  @Field(() => Int) active7d!: number;
}
@ObjectType()
class OrderStats {
  @Field(() => Int) total!: number;
  @Field(() => Int) last30d!: number;
  @Field(() => Float) gmvTotal!: number;
  @Field(() => Float) gmv30d!: number;
}
@ObjectType()
class TierBreakdown {
  @Field() tier!: string;
...
class PlatformTenant {
  @Field(() => ID) orgId!: string;
  @Field() name!: string;
  @Field({ nullable: true }) subscriptionTier?: string;
  @Field({ nullable: true }) billingStatus?: string;
  @Field({ nullable: true }) billingEmail?: string;
  @Field(() => Float, { nullable: true }) monthlyRevenue?: number;
  @Field(() => Int, { nullable: true }) totalLocations?: number;
  @Field({ nullable: true }) notes?: string;
  @Field(() => Int, { nullable: true }) dispensaryCount?: number;
  @Field(() => Int, { nullable: true }) userCount?: number;
  @Field(() => Int, { nullable: true }) orders30d?: number;
  @Field(() => Float, { nullable: true }) revenue30d?: number;
  @Field(() => Date, { nullable: true }) onboardedAt?: Date;
  @Field(() => Date, { nullable: true }) trialEndsAt?: Date;
  @Field(() => Date) createdAt!: Date;
}

@ObjectType()
class PlatformActivity {
  @Field(() => ID) activity_id!: string;
  @Field() activity_type!: string;
  @Field({ nullable: true }) description?: string;
  @Field({ nullable: true }) org_name?: string;
  @Field(() => Date) created_at!: Date;
}

@ObjectType()
class TaxRule {
  @Field(() => Int) tax_category_id!: number;
  @Field() state!: string;
  @Field() code!: string;
  @Field() name!: string;
  @Field(() => Float) rate!: number;
  @Field() tax_basis!: string;
  @Field({ nullable: true }) statutory_reference?: string;
  @Field() is_active!: boolean;
}

@ObjectType()
class BillingInvoice {
  @Field(() => ID) invoice_id!: string;
...
class PlatformReport {
  @Field(() => GraphQLJSON) tenantHealth!: Record<string, unknown>[];
  @Field(() => Float) churnRate!: number;
  @Field(() => Int) totalTenants!: number;
  @Field(() => Int) churned!: number;
}
...
export class PlatformResolver {
  ...
  async tenants(): Promise<unknown[]> {
    return this.platform.getTenants();
  }
  ...
  async updateTenant(
    ...
    return this.platform.updateTenant(orgId, {
      subscriptionTier,
      billingStatus,
      billingEmail,
      notes,
  ...
  async createTenant(
    ...
    @Args('billingEmail') billingEmail: string,
    @Args('subscriptionTier', { defaultValue: 'starter' })
    subscriptionTier: string,
    @Args('state', { defaultValue: 'NY' }) state: string,
  ): Promise<unknown> {
    return this.platform.createTenant({
      name,
      billingEmail,
      subscriptionTier,
      state,
  ...
  async taxRules(): Promise<unknown[]> {
    return this.platform.getTaxRules();
  }
  ...
  async updateTaxRule(
    ...
    return this.platform.updateTaxRule(taxCategoryId, { rate, isActive, name });
  }
  ...
  async invoices(
    ...
    return this.platform.getInvoices(orgId);
  }
  ...
  async activity(
    ...
    return this.platform.getActivity(limit);
  }

  @Roles('super_admin')
  @Query(() => PlatformReport, { name: 'platformReport' })
  async report(): Promise<PlatformReportDto> {
    return this.platform.getPlatformReport();
  }

  @Roles('super_admin')
  @Query(() => [GraphQLJSON], { name: 'subscriptionTiers' })
  async tiers(): Promise<unknown[]> {
    return this.platform.getSubscriptionTiers();
  }
}
