...
export class DeliveryZone {
  ...
  @Field(() => Float, { name: 'radiusMiles' })
  @Column({ type: 'decimal', precision: 6, scale: 2, default: 5.0 })
  radius_miles!: number;
  @Field(() => Float, { name: 'deliveryFee' })
  @Column({ type: 'decimal', precision: 10, scale: 2, default: 0 })
  delivery_fee!: number;
  @Field(() => Float, { name: 'minOrderAmount', nullable: true })
  @Column({ type: 'decimal', precision: 10, scale: 2, nullable: true })
  min_order_amount?: number;
  @Field(() => Float, { name: 'freeDeliveryThreshold', nullable: true })
  @Column({ type: 'decimal', precision: 10, scale: 2, nullable: true })
  free_delivery_threshold?: number;
  @Field(() => Int, { name: 'estimatedMinutesMin', nullable: true })
  @Column({ nullable: true, default: 30 })
  estimated_minutes_min?: number;
  @Field(() => Int, { name: 'estimatedMinutesMax', nullable: true })
