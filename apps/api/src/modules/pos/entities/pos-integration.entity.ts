...
export class PosIntegration {
  @Field(() => ID)
  @PrimaryGeneratedColumn('uuid', { name: 'integration_id' })
  ...
  is_active!: boolean;
  @Field({ name: 'isSyncEnabled' })
  @Column({ default: false, name: 'is_sync_enabled' })
  is_sync_enabled!: boolean;
  @Field(() => Date, { name: 'lastSyncAt', nullable: true })
  @Column({ type: 'timestamptz', nullable: true, name: 'last_sync_at' })
  last_sync_at?: Date;
  @Field({ name: 'lastSyncStatus', nullable: true })
  @Column({ length: 50, nullable: true, name: 'last_sync_status' })
  last_sync_status?: string;
  @Field({ name: 'lastSyncError', nullable: true })
