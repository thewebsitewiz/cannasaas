...
export class TimeEntry {
  ...
  @Field(() => Date, { name: 'clockIn' })
  @Column({ type: 'timestamptz', name: 'clock_in' })
  clock_in!: Date;
  @Field(() => Date, { name: 'clockOut', nullable: true })
  @Column({ type: 'timestamptz', nullable: true, name: 'clock_out' })
  clock_out?: Date;
  @Field(() => Int, { name: 'breakMinutes' })
  @Column({ default: 0, name: 'break_minutes' })
  break_minutes!: number;
  @Field(() => Float, { name: 'totalHours', nullable: true })
  @Column({
    type: 'decimal',
    precision: 6,
    scale: 2,
  ...
  total_hours?: number;
  @Field(() => Float, { name: 'overtimeHours', nullable: true })
  @Column({
    type: 'decimal',
    precision: 6,
    scale: 2,
