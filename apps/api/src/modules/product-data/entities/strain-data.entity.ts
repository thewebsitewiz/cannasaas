...
export class StrainData {
  @Field(() => ID)
  @PrimaryGeneratedColumn('uuid', { name: 'strain_data_id' })
  strainDataId!: string;

  @Field({ name: 'ocpc', nullable: true })
  @Index({ unique: true })
  ...
  @Field(() => Float, { name: 'thcAvg', nullable: true })
  @Column({ type: 'decimal', precision: 6, scale: 3, nullable: true })
  thc_avg?: number;
  @Field(() => Float, { name: 'cbdAvg', nullable: true })
  @Column({ type: 'decimal', precision: 6, scale: 3, nullable: true })
  cbd_avg?: number;
  ...
  @Field({ nullable: true })
  @Column({ length: 50, default: 'otreeba' })
  source?: string;
