    ...
    >
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-2.5">
          <div
            className={`w-8 h-8 rounded-lg flex items-center justify-center text-sm font-black tracking-tighter transition-colors duration-300 ${
              solid
        ...
        <div className="flex items-center gap-2">
          ...
          {isLoggedIn ? (
            ...
            >
              ...
              <span
                className={`text-sm font-medium transition-colors duration-300 ${solid ? 'text-gray-700' : 'text-white/80'}`}
              >
