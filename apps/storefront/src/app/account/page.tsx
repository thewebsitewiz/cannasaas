  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-2xl font-bold font-display text-txt">
            My Account
          </h1>
        ...
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mt-0.5">
              <span className="text-xs text-txt-muted capitalize">
              ...
              {user.ageVerified ? (
                ...
                >
                  <ShieldCheck size={12} /> Verify Age to Order{' '}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
        <Link
          href="/products"
          className="bg-surface border border-bdr rounded-2xl p-6 hover:bg-surface-hover transition-colors"
        >
          <Package size={24} className="text-brand-600 mb-3" />
          <h3 className="font-semibold text-txt mb-1">Browse Menu</h3>
          <p className="text-sm text-txt-muted">
            Explore our curated cannabis menu
          </p>
        </Link>
        {!user.ageVerified && (
          <Link
      ...
      <div className="bg-surface border border-bdr rounded-2xl p-6">
        ...
        <div className="text-center py-8">
          ...
          <Link
            href="/products"
            className="text-sm text-brand-600 hover:text-brand-500 font-medium mt-2 inline-block"
          >
            Browse Menu
          </Link>
        </div>
