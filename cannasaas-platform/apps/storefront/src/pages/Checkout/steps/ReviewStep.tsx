// apps/storefront/src/pages/Checkout/steps/ReviewStep.tsx
// STUB — implement in Part 7 follow-up
import React from 'react';
import { Button } from '@cannasaas/ui';
export function ReviewStep(props: Record<string, unknown>) {
  ...
  return (
    <div className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-[var(--p-radius-lg)] p-8">
      <p className="text-[var(--color-text-secondary)] mb-6">ReviewStep — stub</p>
