...
> = {
  ...
  midnight: {
    label: 'Midnight',
    description:
      'Dark luxury. Electric sage on near-black. Premium after-hours.',
  ...
  apothecary: {
    label: 'Apothecary',
    description:
      'Clinical precision. Navy and slate on cool white. Medical credibility.',
  ...
  neon: {
    label: 'Neon',
    description:
      'Bold streetwear. Electric green & hot pink on black. Unapologetic.',
...
export function ThemePicker({
  ...
  return (
    <div className="gs-card gs-card--padded gs-stack--6">
      ...
      {/* Action bar */}
      <div
        className="gs-flex-between"
        style={{ paddingTop: 8, borderTop: '1px solid var(--color-border)' }}
      >
