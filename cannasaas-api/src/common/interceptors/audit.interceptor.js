...
var audit_service_1 = require("../../modules/compliance/audit/audit.service");
var AuditInterceptor = function () {
    ...
    var AuditInterceptor = _classThis = /** @class */ (function () {
        function AuditInterceptor_1(audit) {
            this.audit = audit;
        }
        AuditInterceptor_1.prototype.intercept = function (ctx, next) {
            var _this = this;
            var request = ctx.switchToHttp().getRequest();
            var method = request.method;
            var action = audit_service_1.AuditAction.ACCESS;
            if (method === 'POST')
            ...
            return next.handle().pipe((0, rxjs_1.tap)(function () {
                ...
                _this.audit.log({
                    ...
                    userId: ((_a = request.user) === null || _a === void 0 ? void 0 : _a.id) || 'anonymous',
                    action: action,
                    ...
                    details: { method: method, url: request.originalUrl,
