...
var TenantService = function () {
    ...
    var _classThis;
    var TenantService = _classThis = /** @class */ (function () {
        function TenantService_1() {
        }
        TenantService_1.prototype.setTenantId = function (tenantId) {
            this.tenantId = tenantId;
        };
        TenantService_1.prototype.getTenantId = function () {
            if (!this.tenantId) {
                throw new Error('Tenant ID not set in request context');
            }
            return this.tenantId;
        };
        return TenantService_1;
    }());
