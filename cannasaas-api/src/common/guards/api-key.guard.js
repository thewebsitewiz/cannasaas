...
var ApiKeyGuard = function () {
    ...
    var ApiKeyGuard = _classThis = /** @class */ (function () {
        function ApiKeyGuard_1(apiKeyService, reflector) {
            this.apiKeyService = apiKeyService;
            this.reflector = reflector;
        }
        ApiKeyGuard_1.prototype.canActivate = function (context) {
            return __awaiter(this, void 0, void 0, function () {
                var request, authHeader, rawKey, apiKey, requiredPermission;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            request = context.switchToHttp().getRequest();
                            authHeader = request.headers['authorization'];
                            if (!(authHeader === null || authHeader === void 0 ? void 0 : authHeader.startsWith('Bearer cs_')))
                                return [2 /*return*/, false];
                            rawKey = authHeader.replace('Bearer ', '');
                            return [4 /*yield*/, this.apiKeyService.validateKey(rawKey)];
                        case 1:
                            apiKey = _a.sent();
                            requiredPermission = this.reflector.get('api_permission', context.getHandler());
