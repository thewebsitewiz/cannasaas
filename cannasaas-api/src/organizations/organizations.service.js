...
var OrganizationsService = function () {
    ...
    var OrganizationsService = _classThis = /** @class */ (function () {
        function OrganizationsService_1(orgRepository) {
            this.orgRepository = orgRepository;
        }
        OrganizationsService_1.prototype.create = function (createDto) {
            return __awaiter(this, void 0, void 0, function () {
                var org;
                return __generator(this, function (_a) {
                    org = this.orgRepository.create(createDto);
                    return [2 /*return*/, this.orgRepository.save(org)];
                });
            });
        };
        OrganizationsService_1.prototype.findAll = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.orgRepository.find({ relations: ['companies'] })];
                });
            });
        };
        OrganizationsService_1.prototype.findOne = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.orgRepository.findOne({
                                where: { id: id },
                                relations: ['companies'],
                            })];
                        case 1:
        ...
        OrganizationsService_1.prototype.update = function (id, updateDto) {
            return __awaiter(this, void 0, void 0, function () {
                var org;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, this.orgRepository.save(org)];
                        case 2:
                            _a.sent();
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            org = _a.sent();
                            return [4 /*yield*/, this.orgRepository.remove(org)];
                        case 2:
                            _a.sent();
                            return [2 /*return*/];
                    }
