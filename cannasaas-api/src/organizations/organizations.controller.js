...
var OrganizationsController = function () {
    var _classDecorators = [(0, common_1.Controller)('organizations')];
    ...
    var OrganizationsController = _classThis = /** @class */ (function () {
        ...
        OrganizationsController_1.prototype.create = function (createDto) {
            return this.organizationsService.create(createDto);
        };
        OrganizationsController_1.prototype.findAll = function () {
            return this.organizationsService.findAll();
        };
        OrganizationsController_1.prototype.findOne = function (id) {
            return this.organizationsService.findOne(id);
        };
        OrganizationsController_1.prototype.update = function (id, updateDto) {
