...
var ProductsController = function () {
    var _classDecorators = [(0, common_1.Controller)('products'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard)];
    ...
    var _updateInventory_decorators;
    var _uploadImage_decorators;
    var ProductsController = _classThis = /** @class */ (function () {
        function ProductsController_1(productsService, uploadService) {
            this.productsService = (__runInitializers(this, _instanceExtraInitializers), productsService);
            this.uploadService = uploadService;
        }
        // --- Categories ---
        ProductsController_1.prototype.createCategory = function (dto) {
            return this.productsService.createCategory(dto);
        };
        ProductsController_1.prototype.findCategories = function (dispensaryId) {
        ...
        ProductsController_1.prototype.findAll = function (dispensaryId, categoryId, productType, strainType, featured, search) {
        ...
        ProductsController_1.prototype.getLowStock = function (dispensaryId) {
        ...
        // --- Inventory ---
        ProductsController_1.prototype.updateInventory = function (variantId, body) {
            return this.productsService.updateInventory(variantId, body.quantityChange);
        };
        // --- Images ---
        ProductsController_1.prototype.uploadImage = function (id, file, primary) {
            return __awaiter(this, void 0, void 0, function () {
                var imageUrl;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.uploadService.uploadFile(file, "products/".concat(id))];
                        case 1:
                            imageUrl = _a.sent();
                            return [2 /*return*/, this.productsService.addProductImage(id, imageUrl, primary === 'true')];
                    }
                });
            });
        };
    ...
    (function () {
        ...
        _findCategories_decorators = [(0, common_1.Get)('categories')];
        _create_decorators = [(0, common_1.Post)()];
        _findAll_decorators = [(0, common_1.Get)()];
        _getLowStock_decorators = [(0, common_1.Get)('low-stock')];
        _findOne_decorators = [(0, common_1.Get)(':id')];
        _update_decorators = [(0, common_1.Put)(':id')];
        _remove_decorators = [(0, common_1.Delete)(':id')];
        _updateInventory_decorators = [(0, common_1.Put)('variants/:variantId/inventory')];
        _uploadImage_decorators = [(0, common_1.Post)(':id/images'), (0, common_1.UseInterceptors)((0, platform_express_1.FileInterceptor)('file'))];
        ...
        __esDecorate(_classThis, null, _updateInventory_decorators, { kind: "method", name: "updateInventory", static: false, private: false, access: { has: function (obj) { return "updateInventory" in obj; }, get: function (obj) { return obj.updateInventory; } }, metadata: _metadata }, null, _instanceExtraInitializers);
