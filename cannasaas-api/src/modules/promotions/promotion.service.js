...
var PromotionService = function () {
    ...
    var PromotionService = _classThis = /** @class */ (function () {
        function PromotionService_1(promoRepo) {
            this.promoRepo = promoRepo;
        }
        PromotionService_1.prototype.validate = function (code, orgId, cart) {
            return __awaiter(this, void 0, void 0, function () {
                var promo, now;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.promoRepo.findOne({
                        ...
                        case 1:
                            ...
                            if (cart.total < Number(promo.minimumOrderValue))
                                throw new common_1.BadRequestException("Minimum order of $".concat(promo.minimumOrderValue, " required"));
                            return [2 /*return*/, this.calculateDiscount(promo, cart)];
                    }
                });
            });
        };
        PromotionService_1.prototype.calculateDiscount = function (promo, cart) {
            ...
            switch (promo.type) {
                ...
                case promotion_entity_1.PromotionType.BUY_X_GET_Y:
                    var _a = promo.conditions || {}, _b = _a.buyQuantity, buyQuantity = _b === void 0 ? 2 : _b, _c = _a.getQuantity, getQuantity = _c === void 0 ? 1 : _c;
                    var eligible = cart.items.filter(function (i) {
                        var _a, _b;
                        return !((_b = (_a = promo.conditions) === null || _a === void 0 ? void 0 : _a.productIds) === null || _b === void 0 ? void 0 : _b.length) ||
                            promo.conditions.productIds.includes(i.productId);
                    });
                    var totalQty = eligible.reduce(function (s, i) { return s + i.quantity; }, 0);
                    var sets = Math.floor(totalQty / (buyQuantity + getQuantity));
                    var cheapest = eligible.sort(function (a, b) { return a.price - b.price; });
