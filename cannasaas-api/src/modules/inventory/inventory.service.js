...
var inventory_item_entity_1 = require("./entities/inventory-item.entity");
...
var InventoryService = function () {
    ...
    var InventoryService = _classThis = /** @class */ (function () {
        function InventoryService_1(invRepo, movementRepo, dataSource, eventEmitter) {
        ...
        InventoryService_1.prototype.adjustStock = function (dto) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.dataSource.transaction(function (manager) { return __awaiter(_this, void 0, void 0, function () {
                            var item, previousQty;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, manager.findOne(inventory_item_entity_1.InventoryItem, {
                                    ...
                                    case 1:
                                        ...
                                        return [4 /*yield*/, manager.save(item)];
                                    case 2:
                                        _a.sent();
                                        return [4 /*yield*/, manager.save(stock_movement_entity_1.StockMovement, {
        ...
        InventoryService_1.prototype.reserveStock = function (items) {
            return __awaiter(this, void 0, void 0, function () {
                var _this = this;
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.dataSource.transaction(function (manager) { return __awaiter(_this, void 0, void 0, function () {
                            var _i, items_1, item, inv;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        _i = 0, items_1 = items;
                                    ...
                                    case 1:
                                        ...
                                        item = items_1[_i];
                                        return [4 /*yield*/, manager.findOne(inventory_item_entity_1.InventoryItem, {
                                    ...
                                    case 2:
                                        ...
                                        if (!inv || inv.quantityOnHand - inv.quantityReserved < item.quantity) {
                                            throw new common_1.BadRequestException("Insufficient stock for product ".concat(item.productId));
                                        }
                                        inv.quantityReserved += item.quantity;
                                        return [4 /*yield*/, manager.save(inv)];
                                    case 3:
                                        _a.sent();
                                        _a.label = 4;
                                    case 4:
