...
var NotificationGateway = function () {
    ...
    var _handleOrderSubscribe_decorators;
    var NotificationGateway = _classThis = /** @class */ (function () {
        function NotificationGateway_1(jwt) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    try {
                        ...
                        client.join("org:".concat(payload.organizationId));
                        client.join("user:".concat(payload.sub));
                        if (['admin', 'manager', 'staff'].includes(payload.role)) {
                            client.join("admin:".concat(payload.organizationId));
                        }
                    }
                    catch (e) {
                        client.disconnect();
        ...
        NotificationGateway_1.prototype.handleDisconnect = function (client) {
            var _a;
            this.logger.log("Client disconnected: ".concat((_a = client.data) === null || _a === void 0 ? void 0 : _a.userId));
        };
        NotificationGateway_1.prototype.handleOrderSubscribe = function (client, orderId) {
            client.join("order:".concat(orderId));
        };
        NotificationGateway_1.prototype.sendToUser = function (userId, event, data) {
            this.server.to("user:".concat(userId)).emit(event, data);
        };
        NotificationGateway_1.prototype.sendToOrg = function (orgId, event, data) {
            this.server.to("org:".concat(orgId)).emit(event, data);
        };
        NotificationGateway_1.prototype.sendToOrder = function (orderId, event, data) {
            this.server.to("order:".concat(orderId)).emit(event, data);
        };
        NotificationGateway_1.prototype.sendToAdmin = function (orgId, event, data) {
            this.server.to("admin:".concat(orgId)).emit(event, data);
        };
    ...
    (function () {
        ...
        _handleOrderSubscribe_decorators = [(0, websockets_1.SubscribeMessage)('subscribe:order')];
        __esDecorate(_classThis, null, _handleOrderSubscribe_decorators, { kind: "method", name: "handleOrderSubscribe", static: false, private: false, access: { has: function (obj) { return "handleOrderSubscribe" in obj; }, get: function (obj) { return obj.handleOrderSubscribe; } }, metadata: _metadata }, null, _instanceExtraInitializers);
