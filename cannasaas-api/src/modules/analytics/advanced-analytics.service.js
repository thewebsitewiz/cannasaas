...
var AdvancedAnalyticsService = function () {
    ...
    var _classThis;
    var AdvancedAnalyticsService = _classThis = /** @class */ (function () {
        function AdvancedAnalyticsService_1(orderRepo, eventRepo) {
            this.orderRepo = orderRepo;
            this.eventRepo = eventRepo;
        }
        AdvancedAnalyticsService_1.prototype.getRevenueTrends = function (orgId_1) {
            return __awaiter(this, arguments, void 0, function (orgId, days) {
                if (days === void 0) { days = 30; }
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.orderRepo.query("\n      SELECT DATE(created_at) as date, COUNT(*) as order_count,\n        SUM(total) as revenue, AVG(total) as avg_order_value,\n        COUNT(DISTINCT customer_id) as unique_customers\n      FROM orders\n      WHERE organization_id = $1\n        AND created_at >= NOW() - INTERVAL '".concat(days, " days'\n        AND status NOT IN ('cancelled', 'refunded')\n      GROUP BY DATE(created_at) ORDER BY date ASC\n    "), [orgId])];
                });
            });
        };
        AdvancedAnalyticsService_1.prototype.getCohortAnalysis = function (orgId) {
        ...
        AdvancedAnalyticsService_1.prototype.getConversionFunnel = function (orgId_1) {
            return __awaiter(this, arguments, void 0, function (orgId, days) {
                var events, funnel;
                if (days === void 0) { days = 7; }
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.eventRepo.query("\n      SELECT event_type, COUNT(DISTINCT session_id) as unique_sessions\n      FROM analytics_events\n      WHERE organization_id = $1\n        AND timestamp >= NOW() - INTERVAL '".concat(days, " days'\n        AND event_type IN ('page_view','product_view','add_to_cart',\n          'begin_checkout','purchase')\n      GROUP BY event_type\n    "), [orgId])];
                        case 1:
                            events = _a.sent();
                            funnel = ['page_view', 'product_view', 'add_to_cart', 'begin_checkout', 'purchase'];
                            return [2 /*return*/, funnel.map(function (step) {
                                    var data = events.find(function (e) { return e.event_type === step; });
                                    return { step: step, sessions: parseInt((data === null || data === void 0 ? void 0 : data.unique_sessions) || '0') };
                                })];
                    }
                });
            });
        };
        return AdvancedAnalyticsService_1;
    }());
