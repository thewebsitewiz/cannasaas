...
describe('TenantsService', function () {
    ...
    describe('TenantsService', function () {
        it('should be created in Sprint 3', function () {
            expect(true).toBe(true);
        });
    });
    describe('findBySubdomain', function () {
        it('should return a tenant when found', function () { return __awaiter(void 0, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        jest.spyOn(repPository, 'findOne').mockResolvedValue(mockTenant);
                        return [4 /*yield*/, service.findBySubdomain('test')];
                    case 1:
                        result = _a.sent();
        ...
        it('should return null when tenant not found', function () { return __awaiter(void 0, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        jest.spyOn(repository, 'findOne').mockResolvedValue(null);
                        return [4 /*yield*/, service.findBySubdomain('nonexistent')];
                    case 1:
                        result = _a.sent();
