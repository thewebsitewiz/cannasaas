...
__decorate([
    ...
    __metadata("design:type", String)
], InventoryItem.prototype, "variantId", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'location_id', type: 'uuid' }),
    __metadata("design:type", String)
], InventoryItem.prototype, "locationId", void 0);
__decorate([
...
__decorate([
    ...
    __metadata("design:type", Number)
], InventoryItem.prototype, "quantityReserved", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'low_stock_threshold', type: 'int', default: 10 }),
    __metadata("design:type", Number)
], InventoryItem.prototype, "lowStockThreshold", void 0);
__decorate([
...
exports.InventoryItem = InventoryItem = __decorate([
    ...
    (0, typeorm_1.Index)(['productId', 'variantId', 'locationId'], { unique: true })
], InventoryItem);
